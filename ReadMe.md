...
Use the [usermode](https://github.com/rajeshsaini2115/ChannelAutoPost/tree/user) branch, if you want to forward messages without being an admin in the from channel.
